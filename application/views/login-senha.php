    ...
    <body>
        ...
        <div id="login">
            <div id="login-box">
                ...
                <form name="form_login" id="form_login" action="<?= base_url() ?>login/criarsenha"
                      method="post">
                    <label id="labelUsuario">CPF</label>
                    <input style="width: 200px;" type="text" id="txtLogin" name="txtCPF" class="texto05" value="<?= @$obj->_login; ?>" />
                    <label id="labelSenha">Email</label>
                    <input style="width: 200px;" type="text" id="txtSenha" name="txtemail"  class="texto08" value="<?= @$obj->_senha; ?>" />
