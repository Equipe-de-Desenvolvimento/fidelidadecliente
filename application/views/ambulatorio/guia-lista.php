                    ...
                    foreach ($exames as $item) :
                        ...
                        <tr>
                            ...
                            <td class="<?php echo $estilo_linha; ?>" width="50px;">       
                                <div class="bt_link_new">
                                    <a target="_blank" href="<?= base_url() . "ambulatorio/guia/impressaoficha/" . $item->paciente_contrato_id ?>">
                                        Carteira
                                    </a>
                                </div>
                            </td>
...
<a target='_blank' href='https://go.gerencianet.com.br/#/cobranca/pagar/7b571b2be28ba7e2b3638f0b7121df634aa60bcd'><img src='https://go.gerencianet.com.br/frontend/images/buttons/bt_pay_orange_round_gradient.png'></a>
           ...
           <table >
                ...
                <td class="<?php echo $estilo_linha; ?>" width="100px;"><a href="<?= base_url() ?>ambulatorio/guia/listardependentes/<?= $titular['0']->paciente_id; ?>/<?= $titular['0']->paciente_contrato_id ?>"><?= $titular['0']->paciente_contrato_id; ?></a></td>
                         <td class="<?php echo $estilo_linha; ?>" width="100px;"><a href="<?= base_url() ?>ambulatorio/guia/listardependentes/<?= $titular['0']->paciente_id; ?>/<?= $titular['0']->paciente_contrato_id ?>"><?= $titular['0']->nome; ?></a></td>
                                                    <td class="<?php echo $estilo_linha; ?>" width="50px;">       
                                <div class="bt_link_new">
