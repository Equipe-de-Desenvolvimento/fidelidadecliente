<div class="content ficha_ceatox"> <!-- Inicio da DIV content -->
    ...
    <form name="form_exametemp" id="form_exametemp" action="<?= base_url() ?>ambulatorio/exametemp/gravarpacienteconsultatemp/<?= $agenda_exames_id ?>/<?=$parceiro_ip?>" method="post">
        <fieldset>
            ...
            <div>
                <!--<label>Nome</label>-->
                <input type="hidden" id="txtNomeid" class="texto_id" name="txtNomeid" readonly="true" value="<?=$paciente_id?>"/>
                <!--<input type="hidden" id="txtNome" name="txtNome" required class="texto10"/>-->
            </div>
