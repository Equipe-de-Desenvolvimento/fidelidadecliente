...
class Exame extends BaseController {
    ...
    function listaragendamentoweb($paciente_id, $args = array()) {
        ...
        $paciente = $this->paciente->listardados($paciente_id);
//        var_dump($paciente[0]->cpf);
//        die;
        if (@$endereco != '') {
...
//            die;
            ...
            $parametro = array(
                ...
                'cpf' => ($paciente[0]->cpf != '') ? $paciente[0]->cpf : 0,
                'nome' => (@$_GET['nome'] != '') ? @$_GET['nome'] : ''
            );

            $url = "especialidade={$parametro['especialidade']}&medico={$parametro['medico']}&situacao={$parametro['situacao']}&data={$parametro['data']}&limit={$parametro['limit']}&pagina={$parametro['pagina']}&cpf={$parametro['cpf']}&nome={$parametro['nome']}";
            @$resposta = file_get_contents("http://{$endereco}/autocomplete/listarexameagendamentowebcpf?{$url}");
...
//            $data['paciente_id'] = $paciente[0]->paciente_id;
        } else {
            $data['medicos'] = array();
            $data['lista'] = array();
        }
